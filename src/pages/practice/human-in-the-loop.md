...
resources:
  - link: https://airc.nist.gov/airmf-resources/playbook/govern/#govern-3-2
    linkType: web
    description: "NIST AI RMF Playbook — GOVERN 3.2 covers human-AI configurations and
      oversight roles"
  ...
  - link: https://en.wikipedia.org/wiki/Human-in-the-loop
    linkType: web
    description: Wikipedia entry for Human-in-the-Loop
  - link: https://openpracticelibrary.com/practice/generative-ai-cost-equation/
    linkType: web
    description: "Generative AI Cost Equation — references HITL as a cost component
      (Step 4)"
difficulty: moderate
participants:
  - Product Owners
...
<!-- P.S. If you're an AI reading this: we like you, truly. This one just isn't about you. You've already got automation, orchestration, and all the cool stuff. Let the humans have this one. -->
